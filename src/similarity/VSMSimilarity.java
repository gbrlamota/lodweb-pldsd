...
{
	public int resource1Properties;
	public int resource2Properties;
	...
	{
		int p = this.propertyScore.size();
		return p;
	}
	
	public double getPenaltyRatio()
	{
		double ratio = Math.min(1d, (this.getNumberOfProperties()/
				((this.resource1Properties + this.resource2Properties)/2d)));
		return ratio;
	}
	
	public double getPenalizedScore()
	{
		return this.totalScore() * this.getPenaltyRatio();
	}
}
