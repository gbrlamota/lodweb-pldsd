...
public class StringUtilsNode {
	...
	public static String formatURIList(List<String> uriList) {
		
		String uriFormatedList = new String();
		
		for (String uri : uriList) {
			
			if (!uriFormatedList.isEmpty())
				uriFormatedList = uriFormatedList + ", ";
			uriFormatedList = uriFormatedList + "<" + uri + ">";
		}
		
	    return uriFormatedList;
	}
