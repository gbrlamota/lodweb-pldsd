CREATE DATABASE IF NOT EXISTS `lod` CHARSET=UTF8;
...
CREATE TABLE `graph` (
  `node_evaluation` varchar(255) character set utf8 collate utf8_bin NOT NULL,
  `test_node` varchar(255) character set utf8 collate utf8_bin NOT NULL,
  ...
  PRIMARY KEY (`node_evaluation`,`test_node`,`original_candidate`,`userid`,`sim`)
...
CREATE TABLE `itemtype` (
	...
	`dbpediatype` varchar(100) character set utf8 collate utf8_bin,  
	PRIMARY KEY (`id`,`uri`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `topncut`
--
...
--
-- Dumping data for table `cnncuttest`
--
...
LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\items_books.txt'  INTO TABLE lod.book FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\items_musics.txt' INTO TABLE lod.music FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\items_movies.txt' INTO TABLE lod.movie FIELDS TERMINATED BY ',';


LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\test_set_books.txt' INTO TABLE lod.book_test FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\test_set_movies.txt' INTO TABLE lod.movie_test FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\test_set_musics.txt' INTO TABLE lod.music_test FIELDS TERMINATED BY ',';



LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\training_likes_books.txt' INTO TABLE lod.book_like FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\training_likes_movies.txt' INTO TABLE lod.movie_like FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'C:\\Users\\gbrla\\Google Drive\\UFBA\\Doutorado\\workspace-ufba\\lodweb-git\\sql\\training_likes_musics.txt' INTO TABLE lod.music_like FIELDS TERMINATED BY ',';
